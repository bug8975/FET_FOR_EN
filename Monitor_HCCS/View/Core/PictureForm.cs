...
namespace Monitor_HCCS.View
{
    public partial class PictureForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void PictureForm_Load(object sender, EventArgs e)
        {
            ...
            ucLabel1.UcText = "Longitude： ";
            ucLabel2.UcText = "Latitude： ";
            ucLabel5.UcText = "Altitude： ";
            ucLabel3.UcText = "Item： " + PictureName;


            Task.Run(new Action(async () =>
            {
                ucLabel4.UcText = "Site： " + await getInfoSite(PictureName);
            ...
            Task.Run(new Action(async () =>
            {
                ucLabel6.UcText = "Dot Pitch： " + await getDistance(PictureName) + "m";
            }));
        }
        //返回
        ...
        private void CutScreen_Click(object sender, EventArgs e)
        {
            ...
            bm.Dispose();
            ShowToast_InPicture("Notice", "截图保存成功", 2);
        }
        #endregion
