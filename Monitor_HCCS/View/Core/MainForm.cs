...
namespace Monitor_HCCS.View
{
    public partial class MainForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private bool initButton()
        {
            ...
            {
                watch15.Start();
                this.simpleButton1.BackgroundImage = global::Monitor_HCCS.Properties.Resources.Collect_1;
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                watch1.Start();
                this.initButton();
                this.simpleButton1.BackgroundImage = global::Monitor_HCCS.Properties.Resources.Collect_2;
                watch1.Stop();
                formSwitchFlag = true;
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                watch4.Start();
                this.initButton();
                this.simpleButton2.BackgroundImage = global::Monitor_HCCS.Properties.Resources.Line_2;
                watch4.Stop();
                formSwitchFlag = true;
                watch1.Start();
        ...
        private void simpleButton3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                watch1.Start();
                this.initButton();
                this.simpleButton3.BackgroundImage = global::Monitor_HCCS.Properties.Resources.Delete_2;
                watch1.Stop();
                formSwitchFlag = true;
                watch3.Start();
        ...
        private void simpleButton4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                watch1.Start();
                this.initButton();
                this.simpleButton4.BackgroundImage = global::Monitor_HCCS.Properties.Resources.Output_2;
                watch1.Stop();
                formSwitchFlag = true;
                watch5.Start();
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                watch1.Start();
                this.initButton();
                this.simpleButton5.BackgroundImage = global::Monitor_HCCS.Properties.Resources.Setting_2;
                watch1.Stop();
                formSwitchFlag = true;
                watch7.Start();
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            {
                ShowToast("Warning", ex.Message, 2);
                Log4netHelper.Error(ex);
            }
            base.WndProc(ref m);
        }
        ...
        {
            DialogResult dr = MessageBoxEX.Show("Notice", "Would you want to turn it off now？");
