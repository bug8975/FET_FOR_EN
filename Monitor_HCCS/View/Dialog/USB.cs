    ...
    public partial class USB : DevExpress.XtraEditors.XtraForm, IUSBView
    {
        ...
        private void BtnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ShowToast("Notice", "The USB is Not Connected", 2);
                    return;
                }

                if (listView1.SelectedItems.Count == 0)
                {
                    ShowToast("Notice", "there aren't any file to be selected", 2);
                    return;
                }
                ...
                foreach (ListViewItem item in listView1.SelectedItems)
                {
                    ...
                    {
                        //ShowToast("Notice", "不存在" + fileName + "文件", 2);
                        continue;
                    }
                ...
                ShowToast("Notice", "The file was exported successfully", 1);
            }
            catch (IOException copyError)
            {
                ShowToast("Notice", copyError.Message, 2);
                return;
            }
        }
        //导出全部
        private void txButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ShowToast("Notice", "there aren't any file", 2);
                    return;
                }
                ...
                ShowToast("Notice", "The file was exported successfully", 2);
            }
            catch (IOException copyError)
            {
                ShowToast("Notice", copyError.Message, 2);
