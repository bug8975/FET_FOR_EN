...
namespace Presenter
{
    public class HomePresenter
    {
        ...
        public void SaveInfo(object sender, EventArgs e)
        {
            ...
            {
                _homeForm.ShowToast("Notice", "测线名称不能为空", 4);
                return;
            }
            if (_homeForm.InfoSite.Equals("") || _homeForm.InfoSite.Equals(" "))
            {
                _homeForm.ShowToast("Notice", "测量地点不能为空", 4);
                return;
            }

            if (_homeRepository.GetInfoByName(TempName) > 0)
            {
                _homeForm.ShowToast("Notice", "测线名称已存在，请重新命名", 4);
                _homeForm.InfoName = "";
                return;
            }
            ...
            {
                _homeForm.ShowToast("Notice", "格式不正确，测线名称不能输入“'”符号", 4);
                _homeForm.InfoName = "";
                return;
            }
            ...
            {
                _homeForm.ShowToast("Notice", "测线名称长度过长，请不要输入超过7个中文字符", 4);
                _homeForm.InfoSite = "";
                return;
            }
            ...
            {
                _homeForm.ShowToast("Notice", "地点名称过长，请不要输入超过7个中文字符", 4);
                _homeForm.InfoSite = "";
                return;
            }
            if (_homeForm.InfoSite.Contains("'"))
            {
                _homeForm.ShowToast("Notice", "格式不正确，测量地点名称不能输入“'”符号", 4);
                _homeForm.InfoSite = "";
                return;
            }
            #endregion
            ...
            {
                _homeForm.ShowToast("Notice", "新建失败", 1);
                return;
            }

            _homeForm.ShowToast("Notice", "新建成功", 1);
        ...
        private void VerifyInfoName(object sender, EventArgs e)
        {
            ...
            if (_homeForm.InfoName.Contains("'"))
            {
                _homeForm.ShowToast("Notice", "格式不正确，测量名称名称不能输入“'”符号", 4);
                _homeForm.InfoName = "";
                return;
            }
        ...
        private void VerifyIncrement(object sender, EventArgs e)
        {
            ...
            {
                _homeForm.ShowToast("Notice", "格式不正确，测点增量必须为正整数", 4);
            ...
            {
                _homeForm.ShowToast("Notice", "测点增量最大为999999", 4);
                _homeForm.Increment = "1";
                return;
            }   
        }
        ...
        private void VerifyDistance(object sender, EventArgs e)
        {
            ...
            {
                _homeForm.ShowToast("Notice", "格式不正确，点距必须为正整数", 4);
            ...
            {
                _homeForm.ShowToast("Notice", "点距最大为999999", 4);
                _homeForm.Distance = "1";
                return;
            }
        }
