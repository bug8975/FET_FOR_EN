...
namespace Monitor_HCCS.Presenter
{
    public class DataPresenter
    {
        ...
        private void AddButton(object sender, EventArgs e)
        {
            ...
            {
                _DataForm.ShowToast("Notice", "The Bluetooth is Not Connected，you need to connect the bluetooth firstly", 1);
                return;
            }
            ...
            try
            {
                ...
                {
                    _DataForm.ShowToast("Notice", "The current project is bound to another bluetooth，Please create a new project!", 3);
                    return;
                }                
            }
            catch (Exception ex)
        ...
        private void PaintButton(object sender, EventArgs e)
        {
            ...
            if (_Data.HZCount < 10)
            {
                _DataForm.ShowToast("Notice", "There's just too little data for the drawing!", 1);
                return;
            }
            ...
            if (SQLiteHelper.IsRePaint(_DataForm.InfoName))
            {
                ...
                #endregion
                //_DataForm.ShowToast("Notice", "正在成图中，请稍后。。。", 2);
                ...
                ThreadPool.QueueUserWorkItem((obj) =>
                {
                    ...
                    {
                        _DataForm.ShowToast("Notice", "The drawing failed", 2);
                        return;
                    }
                ...
                //修改是否重新成图的状态
                //isRePaintPic = true;
                _DataForm.SetPaintButtonText("View");
                SQLiteHelper.UpdateRePaint(_DataForm.InfoName, "0");
                //_DataForm.ShowToast("Notice", "成图成功！", 1);
                return;
            }
        ...
        private void DeleteButton(object sender, EventArgs e)
        {
            ...
            {
                _DataForm.ShowToast("Warning", "Delete failed", 1);
                return;
            }
            ...
            //修改是否重新成图的状态
            //isRePaintPic = true;
            _DataForm.SetPaintButtonText("Draw");
            SQLiteHelper.UpdateRePaint(_DataForm.InfoName, "1");

            _DataForm.ShowToast("Notice", "Delete successful", 1);
        }
        ...
        private void Bluetooth_ValueChanged(MsgType type, string str, byte[] data = null)
        {
            try
            {
                ...
                {
                    _DataForm.ShowToast("Notice", "The Bluetooth could not be connected", 2);
                    _DataForm.SetBluetoothLEText("Not Connected", System.Drawing.Color.Black);
                    return;
                }

                if (str.Equals("Disconnected"))
                {
                    _DataForm.ShowToast("Notice", "The Bluetooth has been disconnected", 2);
                    _DataForm.SetBluetoothLEText("Not Connected", System.Drawing.Color.Black);
                    return;
                }
                ...
                {
                    _DataForm.ShowToast("Notice", "The Bluetooth has been connected", 2);
        ...
        private void InsertDBAndDat()
        {
            ...
            ThreadPool.QueueUserWorkItem((obj) =>
            {
                ...
                _DataForm.ShowToast("Notice", "it is measured successfully", 1);
            });
